...
app.include_router(calendar_router, prefix="/api", dependencies=_protected)
app.include_router(analytics_router, prefix="/api", dependencies=_protected)
app.include_router(pricing_router, prefix="/api", dependencies=_protected)
app.include_router(buyer_router, prefix="/api", dependencies=_protected)
app.include_router(market_router, prefix="/api", dependencies=_protected)
app.include_router(economics_router, prefix="/api", dependencies=_protected)
